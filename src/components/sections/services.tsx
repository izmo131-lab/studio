...
const services: Service[] = [
  {
    ...
    description: 'Reliable and efficient transportation solutions for all types of cargo, ensuring timely delivery.',
  },
  {
    icon: Boxes,
    title: 'Integral Logistics',
    description: 'Comprehensive management of your entire supply chain, from origin to final destination.',
  },
  {
    icon: Warehouse,
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            We provide a complete suite of logistics services to power your business forward.
          </p>
        </div>
