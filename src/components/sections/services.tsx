...
const services: Service[] = [
  {
    ...
    description: 'Solucions de transport fiables i eficients per a tot tipus de càrrega, garantint un lliurament puntual.',
  },
  {
    icon: Boxes,
  ...
  },
  {
    ...
    description: 'Plans logístics a mida dissenyats per satisfer els teus requisits i reptes empresarials únics.',
  },
  {
    icon: BrainCircuit,
