...
export default function DocumentsPage() {
  ...
  const getStatus = (status: string) => {
    ...
    if (lowerCaseStatus === 'pagada') {
      return { label: 'Pagada', className: 'bg-tracking-delivered hover:bg-tracking-delivered/80' };
    }
    if (lowerCaseStatus === 'pendent') {
      return { label: 'Pendent', className: 'bg-tracking-in-warehouse hover:bg-tracking-in-warehouse/80' };
    }
